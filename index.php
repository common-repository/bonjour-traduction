...
function btplugin_row_meta($links, $file)
{
	...
	if($file == $this_plugin)
	{
		$settings_link = '<a href="' . get_admin_url() . 'plugin-install.php?tab=plugin-information&amp;plugin=hello-translate&amp;TB_iframe=true&amp;width=600&amp;height=550" class="thickbox" title="Plus &agrave; propos de Bonjour Traduction version Anglaise 1.0">Version Anglaise</a>';
...
add_filter('plugin_row_meta', 'btplugin_row_meta', 10, 2);

// We need some CSS to position the paragraph
function btplugin_css() {
...
add_action( 'admin_head', 'btplugin_css' );
